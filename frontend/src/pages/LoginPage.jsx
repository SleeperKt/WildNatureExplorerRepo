  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-decoration">
        ...
        <svg
          className="auth-tree tree-right"
          viewBox="0 0 100 200"
      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <div className="auth-tabs">
            ...
            <div
              className={`auth-tab-indicator ${isRegister ? 'right' : 'left'}`}
            ></div>
          </div>
        ...
        <div className="beta-modal-overlay">
          <div className="beta-modal-box">
            ...
            <p className="beta-modal-message">
              This application is currently in <strong>beta testing</strong>.
              Social login features (Google & GitHub) will be available in
              future updates.
            </p>
            <button
      ...
      {showTerms && (
        <div className="terms-modal-overlay">
          <div className="terms-modal-box">
            ...
            <div className="terms-modal-content">{termsText}</div>
