...
export default function SearchPage() {
  ...
  const dropdownFields = [
    ...
    },
    {
      ...
      setSelected: setSelectedHabitats,
    },
    {
      label: 'Colors',
      field: 'colors',
      ...
      <main className="search-main">
        <div className="search-container">
          ...
          <div className="search-header">
            <div className="search-header-icon">{FilterIcon}</div>
          ...
          <div className="search-card-new">
            ...
            <div className="search-filters-grid">
              {dropdownFields.map(
                ({ label, field, icon, items, selected, setSelected }) => (
                  <div key={field} className="search-dropdown">
                    ...
                    >
                      <div className="search-dropdown-tags">
                        {selected.length === 0 ? (
                          <span className="search-dropdown-placeholder">
                          ...
                          selected.map((item) => (
                            <span key={item.id || item} className="search-tag">
                              ...
                              <button
                                ...
                                onClick={(e) =>
                                  removeItem(selected, setSelected, item, e)
                                }
                              >
                                ×
                              </button>
                      ...
                      <span
                        className={`search-dropdown-arrow ${dropdowns[field] ? 'rotated' : ''}`}
                      >
                        <svg
                          viewBox="0 0 24 24"
                          fill="none"
                          ...
                          items.map((item) => {
                            ...
                            return (
                              <button
                                ...
                                onClick={() =>
                                  selectItem(selected, setSelected, item)
                                }
                                disabled={isSelected}
                              >
                                {item.name || item}
                                {isSelected && (
                                  <span className="search-option-check">✓</span>
                                )}
                              </button>
                            );
                          })
