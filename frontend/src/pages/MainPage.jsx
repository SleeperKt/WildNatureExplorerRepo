    ...
    <div className="page-wrapper">
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Your gateway to exploring thousands of species, their habitats, and conservation status. 
            Powered by AI for intelligent wildlife identification.
          </p>
        ...
        <div className="hero-decoration">
          ...
          <div className="mountain-landscape">
            <svg className="mountain mountain-left" viewBox="0 0 400 300" preserveAspectRatio="none">
              <path d="M0 300 L0 300 L200 50 L400 300 Z" fill="rgba(255,255,255,0.06)"/>
            </svg>
            <svg className="mountain mountain-right" viewBox="0 0 400 300" preserveAspectRatio="none">
              <path d="M0 300 L200 30 L400 300 Z" fill="rgba(255,255,255,0.05)"/>
            </svg>
          </div>
          ...
          <svg className="tree-svg tree-left" viewBox="0 0 100 200" fill="rgba(255,255,255,0.08)">
          ...
          <svg className="tree-svg tree-center" viewBox="0 0 80 180" fill="rgba(255,255,255,0.04)">
          ...
          <svg className="animal-svg deer-svg" viewBox="0 0 100 80" fill="rgba(255,255,255,0.06)">
          ...
          <svg className="animal-svg elephant-svg" viewBox="0 0 120 80" fill="rgba(255,255,255,0.05)">
          ...
          <svg className="animal-svg lion-svg" viewBox="0 0 100 70" fill="rgba(255,255,255,0.05)">
      ...
      {showResultCard && searchResult && (
        <div className="result-card-overlay" onClick={closeResultCard}>
          <div className="result-card-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="result-details">
                ...
                {searchResult.colors?.length > 0 && (
                  <div className="detail-row">
                    ...
                    <span className="detail-value">{searchResult.colors.join(", ")}</span>
                  </div>
                )}
                {searchResult.habitats?.length > 0 && (
                  <div className="detail-row">
                    <span className="detail-label">Habitats</span>
                    <span className="detail-value">{searchResult.habitats.join(", ")}</span>
                  </div>
                )}
                {searchResult.countries?.length > 0 && (
                  <div className="detail-row">
                    <span className="detail-label">Found in</span>
                    <span className="detail-value">{searchResult.countries.slice(0, 5).join(", ")}{searchResult.countries.length > 5 ? ` +${searchResult.countries.length - 5} more` : ""}</span>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="result-card-actions">
              <button className="btn btn-outline" onClick={closeResultCard}>Close</button>
              <button className="btn btn-primary" onClick={() => navigate("/geo")}>View on Map</button>
            </div>
          </div>
        </div>
      )}
      ...
      <section className="cta">
        <div className="cta-content">
          ...
          <p>Join thousands of wildlife enthusiasts and start your journey today.</p>
          <div className="cta-buttons">
            <button className="btn btn-primary btn-lg" onClick={() => navigate("/search")}>
              Start Exploring
            </button>
            <button className="btn btn-outline btn-lg" onClick={() => navigate("/ai")}>
              Try AI Assistant
            </button>
          </div>
        </div>
